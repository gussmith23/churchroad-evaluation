...
def _manifest_path() -> Path:
    assert CRE_MANIFEST_PATH_ENV_VAR in os.environ, (
        f"Environment variable {CRE_MANIFEST_PATH_ENV_VAR} is not set. "
        "Please set it to the path of the manifest file."
    )
    return Path(os.environ[CRE_MANIFEST_PATH_ENV_VAR])
